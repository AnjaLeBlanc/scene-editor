...
public class ControllerEventQueue extends Thread {
    ...
    Vector<ControllerEvent> eventQueue = new Vector<ControllerEvent>();
    Vector<ControllerListener> listeners;
     ...
     */
    public ControllerEventQueue(Vector<ControllerListener> listeners, String threadName) {
        super();
        setName(threadName);
	...
	private void monitorEvents() {
        ...
        while(true) {
            synchronized(this) {
                ...
                v = (Vector<ControllerEvent>) eventQueue.clone();
